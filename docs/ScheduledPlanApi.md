# looker_client_30.ScheduledPlanApi
...
api_instance = looker_client_30.ScheduledPlanApi()
...
# create an instance of the API class
api_instance = looker_client_30.ScheduledPlanApi()
body = looker_client_30.ScheduledPlan() # ScheduledPlan | Scheduled Plan (optional)
...
api_instance = looker_client_30.ScheduledPlanApi()
scheduled_plan_id = 789 # int | Scheduled Plan Id
body = looker_client_30.ScheduledPlan() # ScheduledPlan | Scheduled Plan
