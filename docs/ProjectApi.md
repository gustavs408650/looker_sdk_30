...
api_instance = looker_client_30.ProjectApi()
...
# create an instance of the API class
api_instance = looker_client_30.ProjectApi()
body = looker_client_30.Project() # Project | Project (optional)
...
api_instance = looker_client_30.ProjectApi()
project_id = 'project_id_example' # str | Project Id
body = looker_client_30.Project() # Project | Project
fields = 'fields_example' # str | Requested fields (optional)
