...
api_instance = looker_client_30.AuthApi()
body = looker_client_30.OIDCConfig() # OIDCConfig | OIDC test config
...
# create an instance of the API class
api_instance = looker_client_30.AuthApi()
body = looker_client_30.SamlConfig() # SamlConfig | SAML test config
...
# create an instance of the API class
api_instance = looker_client_30.AuthApi()
body = looker_client_30.LDAPConfig() # LDAPConfig | LDAP Config
...
# create an instance of the API class
api_instance = looker_client_30.AuthApi()
body = looker_client_30.OIDCConfig() # OIDCConfig | OIDC Config
...
# create an instance of the API class
api_instance = looker_client_30.AuthApi()
body = looker_client_30.SamlConfig() # SamlConfig | SAML Config
