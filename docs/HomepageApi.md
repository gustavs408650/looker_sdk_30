...
api_instance = looker_client_30.HomepageApi()
...
# create an instance of the API class
api_instance = looker_client_30.HomepageApi()
body = looker_client_30.HomepageItem() # HomepageItem | Homepage Item (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
# create an instance of the API class
api_instance = looker_client_30.HomepageApi()
body = looker_client_30.HomepageSection() # HomepageSection | Homepage section (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_30.HomepageApi()
homepage_item_id = 789 # int | Id of homepage item
body = looker_client_30.HomepageItem() # HomepageItem | Homepage Item
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_30.HomepageApi()
homepage_section_id = 789 # int | Id of homepage section
body = looker_client_30.HomepageSection() # HomepageSection | Homepage section
fields = 'fields_example' # str | Requested fields. (optional)
