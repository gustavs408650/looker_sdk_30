# looker_client_30.IntegrationApi
...
api_instance = looker_client_30.IntegrationApi()
...
# create an instance of the API class
api_instance = looker_client_30.IntegrationApi()
body = looker_client_30.IntegrationHub() # IntegrationHub | Integration Hub (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_30.IntegrationApi()
integration_id = 789 # int | Id of Integration
body = looker_client_30.Integration() # Integration | Integration
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_30.IntegrationApi()
integration_hub_id = 789 # int | Id of Integration Hub
body = looker_client_30.IntegrationHub() # IntegrationHub | Integration Hub
fields = 'fields_example' # str | Requested fields. (optional)
