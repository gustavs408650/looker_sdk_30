...
api_instance = looker_client_30.ConfigApi()
...
# create an instance of the API class
api_instance = looker_client_30.ConfigApi()
body = looker_client_30.BackupConfiguration() # BackupConfiguration | Options for Backup Configuration
...
api_instance = looker_client_30.ConfigApi()
legacy_feature_id = 789 # int | id of legacy feature
body = looker_client_30.LegacyFeature() # LegacyFeature | Legacy Feature
...
# create an instance of the API class
api_instance = looker_client_30.ConfigApi()
body = looker_client_30.WhitelabelConfiguration() # WhitelabelConfiguration | Whitelabel configuration
