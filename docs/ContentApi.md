...
api_instance = looker_client_30.ContentApi()
...
# create an instance of the API class
api_instance = looker_client_30.ContentApi()
body = looker_client_30.ContentFavorite() # ContentFavorite | Favorite Content (optional)
...
# create an instance of the API class
api_instance = looker_client_30.ContentApi()
body = looker_client_30.ContentMetaGroupUser() # ContentMetaGroupUser | Content Metadata Access (optional)
...
api_instance = looker_client_30.ContentApi()
content_metadata_id = 789 # int | Id of content metadata
body = looker_client_30.ContentMeta() # ContentMeta | Content Metadata
...
api_instance = looker_client_30.ContentApi()
content_metadata_access_id = 789 # int | Id of content metadata access
body = looker_client_30.ContentMetaGroupUser() # ContentMetaGroupUser | Content Metadata Access
