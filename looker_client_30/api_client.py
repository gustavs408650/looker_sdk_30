...
import looker_client_30.looker_sdk
from looker_client_30 import rest
...
class ApiClient(object):
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(looker_client_30.looker_sdk, klass)
    ...
    def call_api(self, resource_path, method,
        ...
        :param asynchronous bool: execute request asynchronoushronously
        ...
        :return:
            ...
            the request will be called asynchronoushronously.
        ...
        if not asynchronous:
            ...
            thread = self.pool.apply_asynchronous(self.__call_api, (resource_path,
